...
CREATE TABLE `user` (
                        ...
                        `user_type` ENUM('0','1','2','3') DEFAULT '0' COMMENT '0: guest, 1: customer, 2: seller, 3: admin',
...
#     ADD COLUMN `created_time` DATETIME COMMENT '创建时间' AFTER `status`,
#     ADD COLUMN `modified_time` DATETIME COMMENT '更新时间' AFTER `created_time`,
#     ADD COLUMN `creator` VARCHAR(255) COMMENT '创建者' AFTER `modified_time`,
